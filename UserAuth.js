...
//encapsulate validating whether this session has an uthenticated user
...
function handleLoginAttempt(email,password,cb){
   ...
   .then(function(){
    ...
    .then(function(user)
    {
        ...
        param=user;
        //execute the callback with the appropriate parameters
        cb(null,param);
        })
    .catch(function(err)
    {
    ...
    function handleSignupAttempt(email,password,cb){
        ...
        console.log('userAuth:handleSignupAttempt:email:' +email+ ' password: ' +password);
               console.log(hash+"hey checking for hash");
    ...
    .then(function(user)
    {
        ...
        if(!user)
        {
            ...
            .then(function(){
                user=new User();
                user.email=email;
                console.log(hash+"hash check");
                                console.log(password+"pwd check");
